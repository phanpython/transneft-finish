		...
		<header class="header">
			...
			<main class="content-mask">
				<div class="navigation-chain">
					...
					<div class="navigation-chain__item"><a href="http://trans/maskadd/index">Выбор системы маскирования / </a></div>
					<div class="navigation-chain__item navigation-chain__item_active">{{title}}</div>
				</div>
                <div class="content-mask__body">
                	...
                	{% else %}
						<form action="" method="post" class="content-mask__table table-content-mask table-systems">
                            <div class="table-content-mask__rows table-content-mask__row_header">
								...
								<input type="text" name="system" value="ЦСПА" hidden>
							</div>
							...
							<div class="table-content-mask__rows table-row">
								...
								<div class="table-content-mask__col table-col table-content-mask__textarea">
									<input type="text" name="protection_id-{{i}}" value="{{protection.id}}" hidden>
                                    <textarea type="text" name="protection-{{i}}" class="table-mask-col__textarea table-mask-col__input  protection input-row" value="{{protection.protection_name}}" required="required" style="resize:none; font-size: 14px; width: 100%; overflow: hidden; height: 100%" readonly>{{protection.protection_name}}</textarea>
								</div>
								<div class="table-content-mask__col table-col">
									<label class="check-entrance">
								...
								<div class="table-content-mask__col table-col entrance-on" >
                                    <input type="text" name="type_location-{{i}}" class="table-col__input type_location type_location-{{i}} input-row" readonly>
                                </div>
								...
								<div class="table-content-mask__col table-col col-first entrance-on" >
									<input type="button" name="{{i}}" class="input button button-location-{{i}}" value="Выбрать объект">
								</div>
								<div class="table-content-mask__col table-col entrance-on">
									<label class="check-entrance">
					...
					{% endif %}
						<div class="registration__subtitle-mask">
								Выберите объект:
						</div>
						<div class="tree responsible__tree " name="" hidden style="margin-left: 20px;">
							<div class="tree__content">
								<div class="tree__list">
									{% for object in objects %}
									<div class="tree__item tree__item_top">
										<input type="text" hidden value="{{object.id}}" class="tree__input">
